...
<details>
<summary>点击展开目录∠( ᐛ 」∠)_</summary>

## 目录
- [初识Adobe Photoshop（简称：PS）](#初识adobe-photoshop简称ps)
  - [一、PS的安装](#一ps的安装)
  - [二、项目的 创建 与 保存](#二项目的-创建-与-保存)
  - [三、ps的基础使用](#三ps的基础使用)
- [绘画小技巧](#绘画小技巧)
  - [外部参考图的导入](#外部参考图的导入)
  - [画笔的新建与导入](#画笔的新建与导入)
...
# <a id="初识adobe-photoshop简称ps"></a>初识Adobe Photoshop（简称：PS）
Adobe是企业名称。PS是其旗下的一款专业的图像处理软件。

------

## <a id="一ps的安装"></a>一、PS的安装
ε(*･ω･)_/ﾟ:･☆**安装途径：**
...
*不仅可以使用工具抠图，我们还可以进行选区抠图，这种抠图方式更加灵活，而且可以进行一些高级操作。*
...
- **图层蒙版**【图层和蒙版——从原理理解应用】 https://www.bilibili.com/video/BV1FPPqe6E2j/?share_source=copy_web&vd_source=0160ad3ba70bd037b7b2c8660bd6c92b
